...
const baseRules = [
    ...
    `RULE-SET,speedtest_domain,选择代理`,
    `RULE-SET,Cloudflare_domain,选择代理`,
    `RULE-SET,Wise_domain,选择代理`,
    `RULE-SET,paypal_domain,选择代理`,
    `RULE-SET,proxy_domain,选择代理`,
    `RULE-SET,biliintl_domain,Bilibili`,
    ...
    `RULE-SET,github_domain,选择代理`,
    `RULE-SET,gitbook_domain,选择代理`,
    `RULE-SET,googlevpn_domain,选择代理`,
    ...
    `RULE-SET,line_domain,选择代理`,
    `RULE-SET,talkatone_domain,选择代理`,
    `RULE-SET,talkatone_ip,选择代理,no-resolve`,
    `RULE-SET,discord_domain,选择代理`,
    `RULE-SET,discord_asn,选择代理,no-resolve`,
    `RULE-SET,signal_domain,选择代理`,
    ...
    `RULE-SET,appleTV_domain,选择代理`,
    `RULE-SET,apple_cn_domain,直连`,
    `RULE-SET,apple_firmware_domain,直连`,
    `RULE-SET,apple_domain,直连`,
    `RULE-SET,tiktok_domain,TikTok`,
    `RULE-SET,netflix_domain,Netflix`,
    `RULE-SET,netflix_ip,Netflix,no-resolve`,
    `RULE-SET,disney_domain,选择代理`,
    `RULE-SET,hbo_domain,选择代理`,
    `RULE-SET,primevideo_domain,选择代理`,
    `RULE-SET,emby_domain,选择代理`,
    `RULE-SET,emby_ip,选择代理,no-resolve`,
    `RULE-SET,spotify_domain,Spotify`,
    `RULE-SET,facebook_domain,选择代理`,
    `RULE-SET,whatsapp_domain,选择代理`,
    `RULE-SET,instagram_domain,选择代理`,
    `RULE-SET,threads_domain,选择代理`,
    `RULE-SET,meta_domain,选择代理`,
    `RULE-SET,facebook_ip,选择代理,no-resolve`,
    `RULE-SET,twitch_domain,选择代理`,
    `RULE-SET,porn_domain,选择代理`,
    `RULE-SET,TVB_domain,选择代理`,
    `RULE-SET,media_notcn_domain,选择代理`,
    `RULE-SET,twitter_ip,选择代理,no-resolve`,
    `RULE-SET,steam_domain,选择代理`,
    `RULE-SET,Epic_domain,选择代理`,
    `RULE-SET,EA_domain,选择代理`,
    `RULE-SET,Blizzard_domain,选择代理`,
    `RULE-SET,UBI_domain,选择代理`,
    `RULE-SET,Sony_domain,选择代理`,
    `RULE-SET,Nintendo_domain,选择代理`,
    `RULE-SET,ifast_domain,直连`,
    `RULE-SET,Amazon_domain,选择代理`,
    `RULE-SET,Amazon_ip,选择代理,no-resolve`,
    `RULE-SET,Shopee_domain,选择代理`,
    `RULE-SET,Shopify_domain,选择代理`,
    `RULE-SET,ebay_domain,选择代理`,
...
// eslint-disable-next-line no-unused-vars -- 通��� vm.runInContext 在 yaml_generator 中被调用
